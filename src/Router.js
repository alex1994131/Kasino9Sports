...
const Sports = lazy(() => import("./views/Sports/Sports/index"));
const BetHistory = lazy(() => import("./views/Sports/history/index"));
const Live = lazy(() => import("./views/Sports/Live/index"));
const Upcoming = lazy(() => import("./views/Sports/Upcoming/index"));
    ...
    return (
      <Router history={history}>
        ...
        <Switch>
          ...
          <AppRoute  path="/bethistory" component={BetHistory} SportsLayout/>
